...
namespace c3315176_Assig1.DataAccessLayer {
    ...
    public partial class DS_User : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UserRow AddUserRow(string emailID, string firstName, string lastName, System.DateTime DOB, string password, string admin, string active) {
...
namespace c3315176_Assig1.DataAccessLayer.DS_UserTableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [User] WHERE (([emailID] = @Original_emailID))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [User] ([emailID], [firstName], [lastName], [DOB], [password], [admin" +
                "], [active]) VALUES (@emailID, @firstName, @lastName, @DOB, @password, @admin, @" +
                "active)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [User] SET [emailID] = @emailID, [firstName] = @firstName, [lastName] = @l" +
                "astName, [DOB] = @DOB, [password] = @password, [admin] = @admin, [active] = @act" +
                "ive WHERE (([emailID] = @Original_emailID))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@emailID", global::System.Data.SqlDbType.VarChar, 250, global::System.Data.ParameterDirection.Input, 0, 0, "emailID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT COUNT(*) \r\nFROM [User]\r\nWHERE emailID = @emailID\r\nAND password = @password" +
                "";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@emailID", global::System.Data.SqlDbType.VarChar, 250, global::System.Data.ParameterDirection.Input, 0, 0, "emailID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[3].CommandText = "INSERT INTO [User] ([emailID], [firstName], [lastName], [DOB], [password], [admin" +
                "], [active]) VALUES (@emailID, @firstName, @lastName, @DOB, @password, @admin, @" +
                "active)";
            ...
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@admin", global::System.Data.SqlDbType.VarChar, 5, global::System.Data.ParameterDirection.Input, 0, 0, "admin", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@active", global::System.Data.SqlDbType.VarChar, 9, global::System.Data.ParameterDirection.Input, 0, 0, "active", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(DS_User.UserDataTable dataTable) {
        ...
        public virtual DS_User.UserDataTable GetUsers() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DS_User.UserDataTable dataTable = new DS_User.UserDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DS_User.UserDataTable dataTable) {
        ...
        public virtual int Insert(string emailID, string firstName, string lastName, System.DateTime DOB, string password, string admin, string active) {
            if ((emailID == null)) {
        ...
        public virtual int Update(string emailID, string firstName, string lastName, System.DateTime DOB, string password, string admin, string active, string Original_emailID) {
            if ((emailID == null)) {
                throw new global::System.ArgumentNullException("emailID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstName, string lastName, System.DateTime DOB, string password, string admin, string active, string Original_emailID) {
            return this.Update(Original_emailID, firstName, lastName, DOB, password, admin, active, Original_emailID);
        }
        
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> checkUserEmail(string emailID) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> checkUserLogin(string emailID, string password) {
        ...
        public virtual int InsertUser(string emailID, string firstName, string lastName, string DOB, string password, string admin, string active) {
            ...
            if ((admin == null)) {
                ...
                command.Parameters[5].Value = ((string)(admin));
            }
            if ((active == null)) {
                throw new global::System.ArgumentNullException("active");
            }
            else {
                command.Parameters[6].Value = ((string)(active));
            }
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
